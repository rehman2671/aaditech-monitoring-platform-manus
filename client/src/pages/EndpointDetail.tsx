        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-lg space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              ...
              <label className="space-y-2"><span className="text-slate-400">Asset ID · immutable</span><input value={assetId || 'Assigned on first save'} readOnly disabled className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-slate-400 disabled:opacity-60" placeholder="Assigned on first save" /></label>
