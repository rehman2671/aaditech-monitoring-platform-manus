...
- [ ] Implement bounded historical process performance telemetry with truthful unavailable fields and configurable retention; raw persistence, retention cleanup, and tenant-scoped 5-minute/15-minute/hour/day/week bucket queries are complete, while portal trend integration and longer-term rollup policy remain.
